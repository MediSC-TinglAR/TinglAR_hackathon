...
|주사 시술 중, 아이는 체리 과일을 수집하고 하피콕을 진화</br>시키며 **두려운 시술 과정**을 **보상(진화,간식)을 얻는 통로**로 **치환**함|주사 시술 종료 후, **팔/주사기** 스티커가 스크린 상에서</br>더이상 인식되지 않으면 게임이 종료되고 메인화면으로 돌아가 진화한 하피콕과 상호작용할 수 있음|
