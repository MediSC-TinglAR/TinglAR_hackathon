...
public class DetectImageManager : MonoBehaviour, ISerializationCallbackReceiver
{
    /// <summary>
    ...
    {
        Debug.Log($"Updated {m_Instantiated[trackedImage.referenceImage.guid].name}");
        m_Instantiated[trackedImage.referenceImage.guid].transform.position = trackedImage.transform.position;
    }

    void ReleasePrefab(ARTrackedImage trackedImage)
    {
        Debug.Log($"Destroyed {m_Instantiated[trackedImage.referenceImage.guid].name}");
    ...
    /// </summary>
    [CustomEditor(typeof(DetectImageManager))]
    class DetectImageManagerInspector : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            var behaviour = serializedObject.targetObject as DetectImageManager;
